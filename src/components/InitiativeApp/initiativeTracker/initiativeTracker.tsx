...
export class InitiativeTracker extends React.Component<Props> {
  ...
  sortInitiative(creaturesToSort: Creature[]): Creature[] {
    this.sortedInitiative = creaturesToSort.sort(
  ...
  moveDown = (e: any, creature: Creature) => {
    ...
    const index = this.sortedInitiative.findIndex((gotcha) => {
      return (
        gotcha.name === creature.name &&
        gotcha.initiative === creature.initiative
      );
    });
      ...
      <div>
        <div className="form-check form-switch ms-5 mt-2 mb-2">
          ...
          <label
            ...
            htmlFor="chkCompactView"
          >
            Compact View
          </label>
        </div>
        <ul className="theInitiative text-start">{this.getInitiative()}</ul>
      </div>
    );
  }
  ...
  getInitiative() {
    ...
    return this.sortedInitiative.map((creature: Creature) => (
          ...
          <div className="card-body">
            <div className="row">
              ...
              <div className="col-3">
                <img
                  src="/close_icon.svg"
                  className="btn-close-logo float-end"
                  alt="close icon"
                  onClick={(e) => this.removeCreature(e, creature)}
                ></img>
              </div>
            </div>
            ...
            >
              ...
              <div className="col-4">
                <div className="text-end">
                  ...
                  <img
                    src="shield_icon_fill.svg"
                    className="ac-shield-icon"
                  ></img>
                  <input
                    type="number"
            ...
            <div className="row d-none">
              <div className="col-2">
                <span
                  ...
                  onClick={(e) => this.moveUp(e, creature)}
                >
                  +
                </span>
              </div>
              <div className="col-2">
                <span
                  ...
                  onClick={(e) => this.moveDown(e, creature)}
                >
                  -
                </span>
              </div>
