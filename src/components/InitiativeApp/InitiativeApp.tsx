...
export class InitiativeApp extends React.Component {
  ...
  rollForInitiative = () => {
    ...
    if (this.rollForMe) this.rollVillainInitiative();
  ...
  removeHero = (id: number) => {
    ...
    if (index !== undefined) this.heroes.splice(index, 1);
  ...
  removeVillain = (id: number) => {
    ...
    if (index !== undefined) this.villains.splice(index, 1);

    this.setState({ villains: this.villains });
  };

  removeReminder = (id: number) => {
    let index = this.misc.findIndex((misc) => {
      return misc.id === id;
    });
  ...
  updateHeroes = (heroRolls: string) => {
    ...
    for (let i = 0; i < rolls.length; i++) {
      if (rolls[i] !== '' && rolls[i] !== undefined) {
        ...
        if (critical && roll === 20) goodGuy.critSuccess = true;

        if (critical && roll === 1) goodGuy.critFail = true;
  ...
  updateVillains = (villianRolls: string) => {
    ...
    for (let i = 0; i < rolls.length; i++) {
      if (rolls[i] !== '' && rolls[i] !== undefined) {
        ...
        if (critical && roll === 20) badGuy.critSuccess = true;

        if (critical && roll === 1) badGuy.critFail = true;
  ...
  getCreatureIndexById(
    id: number,
    isVillain: boolean = false,
  ): number | undefined {
    if (isVillain)
      return this.villains.findIndex((villain) => {
    ...
    return this.heroes.map((hero: Hero) => (
      <div>
        <div className="input-group mb-1">
          ...
          <input
            id={'custom-hero-' + hero.name}
            type="text"
            className="form-control"
            placeholder="Character"
            aria-label="Username"
            value={hero.name}
            onChange={(e) => this.customName(e, hero.id)}
          />

          <span className="input-group-text">AC</span>
          <input
            id={'custom-hero-ac-' + hero.ac}
            type="number"
            className="form-control"
            placeholder="Initiative"
            aria-label="Server"
            value={hero.ac}
            onChange={(e) => this.customAc(e, hero.id)}
          />

          <span className="input-group-text">Initiative</span>
          <input
            id={'custom-hero-initiative-' + hero.initiative}
            type="number"
            className="form-control"
            placeholder="Initiative"
            aria-label="Server"
            value={hero.initiative}
            onChange={(e) => this.customInitiative(e, hero.id)}
          />
          ...
          <button
            ...
            type="button"
            id="button-addon2"
            onClick={(e) => this.removeHero(hero.id)}
          >
            Delete
          </button>
        </div>
        <div className="form-check form-check-inline">
          <input
            ...
            type="radio"
            name={'hero-initiative-radio-' + hero.id}
            id={'crit-normal-hero-' + hero.id}
            value="normalInitiative"
            onChange={(e) => this.customCritical(hero.id, 1)}
            defaultChecked={true}
          />
          <label
            className="form-check-label"
            htmlFor={'crit-normal-hero-' + hero.id}
          >
            Normal
          </label>
        </div>
        <div className="form-check form-check-inline mb-3">
          <input
            ...
            type="radio"
            name={'hero-initiative-radio-' + hero.id}
            id={'crit-success-hero-' + hero.id}
            value="critSuccess"
            onChange={(e) => this.customCritical(hero.id, 2)}
          />
          <label
            className="form-check-label"
            htmlFor={'crit-success-hero-' + hero.id}
          >
            Crit Success
          </label>
        </div>
        <div className="form-check form-check-inline mb-3">
          <input
            ...
            type="radio"
            name={'hero-initiative-radio-' + hero.id}
            id={'crit-fail-hero-' + hero.id}
            value="critFail"
            onChange={(e) => this.customCritical(hero.id, 3)}
          />
          <label
            className="form-check-label"
            htmlFor={'crit-fail-hero-' + hero.id}
          >
            Crit Fail
          </label>
        </div>
  ...
  getVillainEditor() {
    return this.villains.map((villain: Villain) => (
      <div id="custom-villain-form">
        <div className="input-group mb-3">
          <span className="input-group-text">Villain</span>
          <input
            id={'custom-hero-' + villain.name}
            type="text"
            className="form-control"
            placeholder="Character"
            aria-label="Username"
            value={villain.name}
            onChange={(e) => this.customName(e, villain.id, true)}
          />

          <span className="input-group-text">AC</span>
          <input
            id={'custom-hero-ac-' + villain.ac}
            type="number"
            className="form-control"
            placeholder="Initiative"
            aria-label="Server"
            value={villain.ac}
            onChange={(e) => this.customAc(e, villain.id, true)}
          />

          <span className="input-group-text">
            {this.rollForMe ? 'Init Bonus' : 'Initiative'}
          </span>
          <input
            id={'custom-hero-initiative-' + villain.initiative}
            type="number"
            className="form-control"
            placeholder="Initiative"
            aria-label="Server"
            value={this.rollForMe ? villain.bonus : villain.initiative}
            onChange={(e) => this.customInitiative(e, villain.id, true)}
          />
          ...
          <button
            ...
            type="button"
            id="button-addon2"
            onClick={(e) => this.removeVillain(villain.id)}
          >
            Delete
          </button>
        </div>
        ...
        >
          <div className="form-check form-check-inline">
            <input
              className="form-check-input"
              type="radio"
              name={'villain-initiative-radio-' + villain.id}
              id={'crit-normal-villian-' + villain.id}
              value="normalInitiative"
              onChange={(e) => this.customCritical(villain.id, 1, true)}
              defaultChecked={true}
            />
            <label
              className="form-check-label"
          ...
          <div className="form-check form-check-inline mb-3">
            <input
              ...
              type="radio"
              name={'villain-initiative-radio-' + villain.id}
              id={'crit-success-villian-' + villain.id}
              value="critSuccess"
          ...
          <div className="form-check form-check-inline mb-3">
            <input
              ...
              type="radio"
              name={'villain-initiative-radio-' + villain.id}
              id={'crit-fail-villian-' + villain.id}
              value="critFail"
  ...
  getMiscEditor() {
    return this.misc.map((reminder: Reminder) => (
      <div>
        <div className="input-group mb-3">
          <span className="input-group-text">Name</span>
          <input
            id={'custom-hero-' + reminder.name}
            type="text"
            className="form-control"
            placeholder="Event/NPC"
            aria-label="Username"
            value={reminder.name}
            onChange={(e) => this.customReminderName(e, reminder.id)}
          />
          ...
          <select
            ...
            defaultValue={0}
            onChange={(e) => this.reminderOptions(e, reminder.id)}
          >
          ...
          <span className="input-group-text">Initiative</span>
          <input
            id={'custom-hero-initiative-' + reminder.initiative}
            type="number"
            className="form-control"
            placeholder="Initiative"
            aria-label="Server"
            value={reminder.initiative}
            onChange={(e) => this.reminderInitiative(e, reminder.id)}
          />
          ...
          <button
            ...
            type="button"
            id="button-addon2"
            onClick={(e) => this.removeReminder(reminder.id)}
          >
            Delete
          </button>
        </div>
          ...
          <div className="col-lg-7">
                  ...
                  <div className="accordion-body">
                    ...
                    >
                      <li className="nav-item" role="presentation">
                        <button
                          ...
                          id="pills-heroes-quick-tab"
                          data-bs-toggle="pill"
                          data-bs-target="#pills-heroes-quick"
                          type="button"
                          role="tab"
                          aria-controls="pills-heroes-quick"
                          aria-selected="true"
                        >
                          Quick
                        </button>
                      ...
                      <li className="nav-item" role="presentation">
                        <button
                          className="nav-link"
                          id="pills-heroes-custom-tab"
                          data-bs-toggle="pill"
                          data-bs-target="#pills-heroes-custom"
                          type="button"
                          role="tab"
                          aria-controls="pills-heroes-custom"
                          aria-selected="false"
                        >
                          Custom
                        </button>
                    ...
                    <div className="tab-content" id="pills-tabContent">
                      <div
                        ...
                        id="pills-heroes-quick"
                        role="tabpanel"
                        aria-labelledby="pills-heroes-quick-tab"
                      >
                        {/* Simple Editor */}
                        <div className="input-group mt-3 mb-3">
                          ...
                          <textarea
                            ...
                            onChange={(event) =>
                              this.updateHeroes(event.target.value)
                            }
                          ></textarea>
                        </div>
                        <p className="fw-light">
                          Just type the initiative rolls your party gives you
                          here {'('}separated by spaces, commas, or lines{')'},
                          and we'll generate a hero for each result. Type an *
                          after a 1 or 20 to denote critical rolls. You can edit
                          names and details afterwards.
                        </p>
                      </div>

                      <div
                        className="tab-pane fade"
                        id="pills-heroes-custom"
                        role="tabpanel"
                        aria-labelledby="pills-heroes-custom-tab"
                      >
                        {/* Custom Editor */}
                        ...
                        <button
                          className="btn btn-secondary col-6 mx-auto mb-3"
                          type="button"
                          id="btn-add-hero"
                  ...
                  <div className="accordion-body">
                    ...
                    >
                      <li className="nav-item" role="presentation">
                        <button
                          className="nav-link active"
                          id="pills-villains-quick-tab"
                          data-bs-toggle="pill"
                          data-bs-target="#pills-villains-quick"
                          type="button"
                          role="tab"
                          aria-controls="pills-villains-quick"
                          aria-selected="true"
                        >
                          Quick
                        </button>
                      ...
                      <li className="nav-item" role="presentation">
                        <button
                          className="nav-link"
                          id="pills-villains-custom-tab"
                          data-bs-toggle="pill"
                          data-bs-target="#pills-villains-custom"
                          type="button"
                          role="tab"
                          aria-controls="pills-villains-custom"
                          aria-selected="false"
                        >
                          Custom
                        </button>
                    ...
                    <div className="tab-content" id="pills-tabContent">
                      <div
                        className="tab-pane fade show active"
                        id="pills-villains-quick"
                        role="tabpanel"
                        aria-labelledby="pills-villains-quick-tab"
                      >
                        {/* Villains List */}
                        <div className="input-group mt-3 mb-3">
                          <span className="input-group-text">
                          ...
                          <textarea
                            ...
                            aria-label="With textarea"
                            onChange={(event) =>
                              this.updateVillains(event.target.value)
                            }
                          ></textarea>
                        </div>

                        <p className="fw-light">
                          Just type the initiative rolls for your villains here{' '}
                          {'('}separated by spaces, commas, or lines{')'}, and
                          we'll generate a villain for each result. Type an *
                          after a 1 or 20 to denote critical rolls. You can edit
                          the names and details afterwards.
                        </p>
                      </div>

                      <div
                        className="tab-pane fade"
                        id="pills-villains-custom"
                        role="tabpanel"
                        aria-labelledby="pills-villains-custom-tab"
                      >
                        {/* Custom Editor */}
                        <div className="input-group mt-3 mb-3">
            ...
            <div id="button-group" className="mt-3 mb-3">
              <button
                ...
                onClick={this.clearInitiative}
              >
                Clear
              </button>
              <button
                className="btn btn-danger btn-fireball btn-large"
                onClick={this.rollForInitiative}
              >
                Roll For Initiative!
                <img
                  src="/Fireball.svg"
                  className="btn-fireball-logo"
                  alt="fireball logo"
                ></img>
              </button>
            </div>
